...
<details>
<summary>Challenge #3 - Adding Unit Tests for the percentage function</summary>

### Adding Unit Tests for the percentage function

1. See if you can now add additional unit tests for the percentage function you created in the core exercise.
...
### Fix errors
1. Go to the `controller.js` file on line 19, and add a single comma. This will generate a compiler error.
